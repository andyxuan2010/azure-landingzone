...
- Standardized `environments/sandbox/terraform.tfvars` features, cleaned up variables, ran `terraform fmt -recursive` on the repo, and successfully validated root configuration.
