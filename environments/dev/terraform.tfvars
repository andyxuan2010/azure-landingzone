...
# Leave these values empty ("") to use secrets from winvm_admin_credentials_key_vault_id or the landing zone Key Vault.
winvm_admin_username                 = ""
winvm_admin_password                 = ""
winvm_admin_credentials_key_vault_id = ""
...
enable_sqldb = true
# Azure SQL free offer profile: serverless, 100,000 vCore seconds, 32GB data, and 32GB backup per month.
