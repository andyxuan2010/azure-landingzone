...
prod_subscription_id         = "1ec5edd4-5654-4246-8027-b29ef63b3393"
prod_tenant_id               = "d5b038fb-4b39-41cc-8a10-fba75212180b"
identity_subscription_id     = "74c3c03d-217f-4138-b9a6-79145d37781a"
identity_tenant_id           = "d5b038fb-4b39-41cc-8a10-fba75212180b"
management_subscription_id   = "624ce74e-cf6e-4eed-afba-352bcf08bca0"
management_tenant_id         = "d5b038fb-4b39-41cc-8a10-fba75212180b"
connectivity_subscription_id = "d3927a5b-0ea7-40e1-bbb5-d3ba34515fb0"
connectivity_tenant_id       = "d5b038fb-4b39-41cc-8a10-fba75212180b"
security_subscription_id     = "903e61ee-68d8-4fee-aefd-5e207a6b0892"
security_tenant_id           = "d5b038fb-4b39-41cc-8a10-fba75212180b"
...
enable_management_group = false
platform_mg_name        = "mg-platform-dev"
landingzone_mg_name     = "mg-landingzone-dev"
sandbox_mg_name         = "mg-sandboxes"
landingzone_mg_display  = "Landing Zones Dev"
platform_mg_display     = "Platform Dev"
...
hierarchy_subscriptions = {
  landingzone = {
    subscription_name        = "sub-landingzone-dev"
  ...
  #   subscription_alias_name    = "sub-connectivity-hub-dev"
  #   subscription_name          = "sub-connectivity-hub-dev"
  ...
  identity_services = {
    subscription_name        = "sub-identity-services-dev"
    existing_subscription_id = "/subscriptions/74c3c03d-217f-4138-b9a6-79145d37781a"
    management_group_key     = "identity"
  }
  security_tools = {
    subscription_alias_enabled = true
    subscription_alias_name    = "sub-security-tools-dev"
    subscription_name          = "sub-security-tools-dev"
    billing_scope_id           = "/providers/Microsoft.Billing/billingAccounts/4731eb74-36ce-5a78-aebe-3f1ac242125d:baddfb2d-4636-4058-912a-f5493d28e166_2019-05-31/billingProfiles/RVBO-3VST-BG7-PGB/invoiceSections/ZSKE-S42H-PJA-PGB"
    existing_subscription_id   = ""
  ...
  management_shared = {
    subscription_name        = "sub-management-shared-dev"
    existing_subscription_id = "/subscriptions/624ce74e-cf6e-4eed-afba-352bcf08bca0"
...
managed_identity_name = "" # default: id-platform-cc-dev
storage_account_name  = "" # default: stplatformccdev
key_vault_name        = "" # default: kvplatformccdev
log_analytics_name    = "" # default: law-platform-cc-dev
firewall_name         = "" # default: afw-platform-cc-dev
route_table_name      = "" # default: rt-platform-cc-dev-egress
adf_name              = "" # default: adf-platform-cc-dev
...
databricks_name                                  = "dbr-platform-cc-dev"
...
databricks_private_endpoint_vnet_name                   = "vnet-spoke-platform-dev"
databricks_private_endpoint_network_resource_group_name = "rg-platform-dev"
#databricks_private_endpoint_subresource_names           = ["databricks_ui_api", "browser_authentication"]
...
winvm_admin_credentials_key_vault_id = "/subscriptions/1ec5edd4-5654-4246-8027-b29ef63b3393/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.KeyVault/vaults/kv-ccoe-cc-dev"
winvm_admin_username_secret_name     = "azure-user"
winvm_admin_password_secret_name     = "azure-password"

winvm_iac_rg = "rg-ccoe-iac-cc-dev"
winvm_iac_kv = "kv-ccoe-cc-dev"
winvm_iac_st = "stccoeiacccdev"
...
winvm_domain                           = "2join.us"
winvm_domain_join_user                 = "serviceaccount@2join.us"
...
winvm_app_admin_group = ["85052ddf-9641-48d9-a0a9-faf8d322f573"]
winvm_tags = {
...
# SQL administrator values for dev.
enable_sqldb = true
...
sql_iac_rg = "rg-ccoe-iac-cc-dev"
sql_iac_kv = "kv-ccoe-cc-dev"
...
app_services = {
  dotnet = {
    ...
    # Add entries after the public DNS validation records exist.
    # custom_hostname_bindings = {
    #   primary = { hostname = "dotnet.andyxuan.ca" }
    # }
    ...
    deployment_center_repo_url               = "https://github.com/andyxuan2010/web-ccoedemo-dotnet"
    deployment_center_azure_repos_branch     = "main"
    deployment_center_use_manual_integration = true

    # if deployed from ADO
    ...
    # if deployed from external zip deploy
  ...
  node = {
    ...
    # Add entries after the public DNS validation records exist.
    # custom_hostname_bindings = {
    #   primary = { hostname = "node.andyxuan.ca" }
    # }
    # deployment_method options:
    # - "deployment_center"
    # - "run_from_package"
  ...
  # - "external_zip_deploy" : prebuilt ZIP pushed by pipeline and extracted by App Service
  python = {
    enabled      = true
    stack        = "python"
    kind         = "Linux"
    ...
    # Add entries after the public DNS validation records exist.
    # custom_hostname_bindings = {
    #   primary = { hostname = "python.andyxuan.ca" }
    # }

    #deployment_center_use_manual_integration = false
  }
}

app_service_plan_enable_diagnostics                 = false
...
app_service_scm_ip_restrictions = [
  {
    name       = "Allow-SCM-107-171-157-217"
    priority   = 100
    action     = "Allow"
    ip_address = "107.171.157.217/32"
  }
...
automation_accounts = {
  default = {
    enabled = true
    # name                          = "aa-platform-eastus-dev-default"
    sku_name                        = "Basic"
...
linux_vm_iac_kv_id = "/subscriptions/1ec5edd4-5654-4246-8027-b29ef63b3393/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.KeyVault/vaults/kv-ccoe-cc-dev"
...
linux_vm_iac_rg = "rg-ccoe-iac-cc-dev"
linux_vm_iac_kv = "kv-ccoe-cc-dev"
...
linux_vm_domain_join_user = "serviceaccount@2join.us"
linux_vm_domain_join_ou   = "azure"

# linux_vm_iac_rg = "rg-platform-dev"
...
# linux_vm_resource_group_name      = "rg-platform-dev"
...
# linux_vm_vnet_name    = "vnet-spoke-platform-dev"
# linux_vm_vnet_resource_group_name = "rg-platform-dev"
...
linux_vm_app_admin_group = ["85052ddf-9641-48d9-a0a9-faf8d322f573"]
