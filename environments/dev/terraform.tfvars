...
managed_identity_name = "" # default: id-platform-eus-dev
storage_account_name  = "" # default: stplatformeusdev
key_vault_name        = "" # default: kvplatformeusdev
log_analytics_name    = "" # default: law-platform-eus-dev
firewall_name         = "" # default: afw-platform-eus-dev
route_table_name      = "" # default: rt-platform-eus-dev-egress
adf_name              = "" # default: adf-platform-dev
enable_adf            = false

# Azure Data Factory defaults for dev:
# - SHIR stays disabled for now.
# - Private endpoint stays disabled for now.
# - Diagnostics flow to the shared Log Analytics workspace.
# - Feature flag stays off until we intentionally enable this environment.
adf_public_network_enabled                  = false
adf_managed_virtual_network_enabled         = true
adf_self_hosted_integration_runtime_enabled = false
adf_enable_private_endpoint                 = false
adf_enable_diagnostics                      = true
...
enable_sqldb = false
# Lowest-cost shared-module profile for test/demo use.
sql_sku_name                      = "Basic"
sql_max_size_gb                   = 2
...
automation_accounts = {
  default = {
    ...
    # Disabled here because this environment already ends up with an Automation Account
    # diagnostic setting outside Terraform, which causes repeated "already exists"
    # collisions on fresh/local state runs.
...
linux_vm_admin_password = "ChangeMeLinuxVm123!"
linux_vm_admin_username = "azureadmin"
...
# Set linux_vm_ado_runner_count to 2 or 3 when you want multiple Azure DevOps agents on the same VM.
