...
locals {
  ...
  adf_name                     = trimspace(var.adf_name) != "" ? var.adf_name : "adf-${var.workload}-${var.environment}"
...
module "linux_vm_basic" {
  ...
  admin_username_secret_name = var.linux_vm_admin_username_secret_name
  admin_password_secret_name = var.linux_vm_admin_password_secret_name
  admin_ssh_key_secret_name  = var.linux_vm_admin_ssh_key_secret_name
  ...
  iac_kv_id                    = trimspace(var.linux_vm_iac_kv_id) != "" ? var.linux_vm_iac_kv_id : module.keyvault.id
